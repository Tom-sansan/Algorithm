...
namespace ExChapter02
{
    public class Q2_05_Sum_Lists
    {
        ...
        {
            int value = 0;
            if (node.Next != null) value = 10 * LinkedListToInt(node.Next);
        ...
        public static void Q2_05_Run()
        {
            #region First Part
            {
                var lA1 = new LinkedListNode(7, null, null);
                var lA2 = new LinkedListNode(1, null, lA1);
                var lA3 = new LinkedListNode(6, null, lA2);

                var lB1 = new LinkedListNode(5, null, null);
                var lB2 = new LinkedListNode(9, null, lB1);
                var lB3 = new LinkedListNode(2, null, lB2);
